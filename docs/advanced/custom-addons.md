...
You may write an add-component for your vehicles easily by deriving from the **VehicleBehaviour** class
instead of MonoBehaviour. VehicleBehaviours have these advantages:
...
&fa-exclamation-circle; **Do NOT override OnEnable or OnDisable!** Always use OnEnableComponent and
